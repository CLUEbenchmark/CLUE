...
TASK_NAME="xnli"
export PREV_TRAINED_MODEL_DIR=gs://models_zxw/prev_trained_models/nlp/albert-tiny/albert_tiny_207k
export DATA_DIR=gs://data_zxw/nlp/chineseGLUEdatasets.v0.0.1/$TASK_NAME
export OUTPUT_DIR=gs://models_zxw/fine_tuning_models/nlp/albert-tiny/albert_tiny_207k/tpu/$TASK_NAME/$CURRENT_TIME
...
python $CURRENT_DIR/../run_classifier.py \
  ...
  --num_tpu_cores=8 --use_tpu=True --tpu_name=grpc://10.2.101.2:8470
